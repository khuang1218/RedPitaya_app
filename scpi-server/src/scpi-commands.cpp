...
static const scpi_command_t scpi_commands[] = {
    ...
    SCPI_CMD("BNET:COMMIT:ALL", RP_BNetCommitAll),
    SCPI_CMD("BNET:MODE", RP_BNetMode),
    SCPI_CMD("BNET:MODE?", RP_BNetModeQ),
    SCPI_CMD("BNET:CONFIG", RP_BNetConfig),
    SCPI_CMD("BNET:CONFIG?", RP_BNetConfigQ),
    SCPI_CMD("BNET:WEIGHT:REUSE", RP_BNetStaticWeightReuse),
    SCPI_CMD("BNET:WEIGHT:REUSE?", RP_BNetStaticWeightReuseQ),
    SCPI_CMD("BNET:PIPELINE", RP_BNetStaticPipeline),
    SCPI_CMD("BNET:PIPELINE?", RP_BNetStaticPipelineQ),
    SCPI_CMD("BNET:VLEN", RP_BNetVectorLength),
    SCPI_CMD("BNET:VLEN?", RP_BNetVectorLengthQ),
    SCPI_CMD("BNET:STREAM:COUNT?", RP_BNetStreamCountQ),
    SCPI_CMD("BNET:ACTIVE?", RP_BNetActiveMaskQ),
    SCPI_CMD("BNET:PENDING?", RP_BNetPendingMaskQ),
    SCPI_CMD("BNET:ERROR?", RP_BNetErrorMaskQ),
    SCPI_CMD("BNET:TIME#?", RP_BNetTimingQ),
    SCPI_CMD("BNET:STREAM#:BASE#", RP_BNetStreamBase),
    SCPI_CMD("BNET:STREAM#:BASE#?", RP_BNetStreamBaseQ),
    SCPI_CMD("BNET:STREAM#:LENGTH", RP_BNetStreamLength),
    SCPI_CMD("BNET:STREAM#:LENGTH?", RP_BNetStreamLengthQ),
    SCPI_CMD("BNET:STREAM#:STRIDE", RP_BNetStreamStride),
    SCPI_CMD("BNET:STREAM#:STRIDE?", RP_BNetStreamStrideQ),
    SCPI_CMD("BNET:STREAM#:FORMAT", RP_BNetStreamFormat),
    SCPI_CMD("BNET:STREAM#:FORMAT?", RP_BNetStreamFormatQ),
    SCPI_CMD("BNET:STREAM#:ENABLE", RP_BNetStreamEnable),
    SCPI_CMD("BNET:STREAM#:ENABLE?", RP_BNetStreamEnableQ),
    SCPI_CMD("BNET:STREAM#:COMMIT#", RP_BNetStreamCommit),
    SCPI_CMD("BNET:STREAM#:SWAP", RP_BNetStreamSwap),
    ...
    SCPI_CMD("BNET:DDR:SLOT#:RELEASE", RP_BNetDdrSlotRelease),
    SCPI_CMD("BNET:DDR:SLOT#:BASE?", RP_BNetDdrSlotBaseQ),
    SCPI_CMD("BNET:DDR:SLOT#:SIZE?", RP_BNetDdrSlotSizeQ),
    SCPI_CMD("BNET:DDR:SLOT#:STREAM#:BUF#", RP_BNetDdrSlotAttach),
    SCPI_CMD("BNET:DDR:SLOT#:OFFSET#:DATA#", RP_BNetDdrSlotData),
